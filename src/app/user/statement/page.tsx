        ...
        <main className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                {metrics.map((m) => (
                    <Card
                        key={m.id}
                        className={`flex items-center justify-between bg-(${m.colorVar}) text-(${m.textVar})`}
                    >
                                            ...
                                            {statementRows.map((r, idx) => (
                                                <tr key={idx} className={idx % 2 === 0 ? "bg-surface-secondary" : ""}>
                                                    ...
                                                    <td className="px-3 py-2 align-top">
                                                        <Badge
                                                            className="border bg-(--state-success-bg) text-(--state-success-text) border-(--state-success-border)"
                                                        >
                                                            {r.type}
                                                        </Badge>
                                                    </td>
                                    ...
                                    <CardContent>
                                        <ul role="list" className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                                            <li className="flex items-center gap-3">
                                                <span className="inline-block h-6 w-6 rounded-md border bg-(--btn-primary-bg)" aria-hidden />
                                                <span>Cargos de colegiaturas</span>
                                            </li>
                                            <li className="flex items-center gap-3">
                                                <span className="inline-block h-6 w-6 rounded-md border bg-chart-2" aria-hidden />
                                                <span>Abonos regulares</span>
                                            </li>
                                            <li className="flex items-center gap-3">
                                                <span className="inline-block h-6 w-6 rounded-md border bg-chart-5" aria-hidden />
                                                <span>Beca aprobada y liberada</span>
                                            </li>
                                            <li className="flex items-center gap-3">
                                                <span className="inline-block h-6 w-6 rounded-md border bg-chart-4" aria-hidden />
                                                <span>Beca pendiente de liberación</span>
                                            </li>
                                            <li className="flex items-center gap-3">
                                                <span className="inline-block h-6 w-6 rounded-md border bg-destructive" aria-hidden />
                                                <span>Beca no liberada o cancelada</span>
                                            </li>
                                            <li className="flex items-center gap-3">
                                                <span className="inline-block h-6 w-6 rounded-md border bg-sidebar-primary" aria-hidden />
